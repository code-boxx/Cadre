...
<h3>CADRE</h3>
<div class="mb-3">open source php staff management system</div>
<div class="bg-white border p-3">
  <h6>Links & Documentation</h6>
  <ul>
    <li><a href="https://code-boxx.com/cadre-php-staff-management-system/" target="_blank">Cadre Official Webpage</a></li>
    <li><a href="https://github.com/code-boxx/Cadre" target="_blank">GitHub</a></li>
  </ul>
