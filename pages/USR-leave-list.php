...
$_CORE->load("Leave");
$leave = $_CORE->Leave->getAllTaken(
  $_POST["year"], $_SESS["user"]["user_id"]
);
...
<div class="d-flex align-items-center border p-2">
  <div class="flex-grow-1">
    <div class="fw-bold">
      <i class="mi">date_range</i> <?=$l["leave_from"]?> to <?=$l["leave_to"]?> 
      (<?=LEAVE_TYPES[$l["leave_type"]]?>)
    </div>
    <div>
      <i class="mi">checklist</i> <?=LEAVE_STATUS[$l["leave_status"]]?>
    </div>
  </div>
  <div>
